...
const TrainScheduleTable = ({trains, sortBy, sortOrder, containerHeight, onSort, onEdit, onDelete}: TrainScheduleTableProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isAuthenticated && <Box p={4} textAlign="left" flexBasis="15%">Actions</Box>}
      </Flex>
