...
{ label: 'Departure time', key: 'departureTime', basis: '15%', sortable: true, formatter: formatDateTime },
{ label: 'Arrival time', key: 'arrivalTime', basis: '15%', sortable: true, formatter: formatDateTime },
];